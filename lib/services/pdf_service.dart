...
class PdfService {
  ...
  static Future<void> generateBatchEmploiPdf(
    List<Emploi> emplois,
    Map<int, String> groupeNames,
    int semaineNum,
  ) async {
    ...
    for (var emploi in emplois) {
      final groupeName =
          groupeNames[emploi.groupeId] ?? 'Groupe #${emploi.groupeId}';
      pdf.addPage(
        pw.Page(
      ...
      pdf.addPage(
        pw.Page(
          build: (context) => pw.Center(
            child: pw.Text('Aucun emploi du temps trouvé pour cette semaine.'),
          ),
        ),
      );
    }
  ...
  static Future<void> generateEmploiPdf(
    Emploi emploi, {
  ...
  static Future<void> generateFormateurEmploiPdf(
    List<Creneau> creneaux, {
    required String formateurName,
    required int semaineNum,
  }) async {
    final pdf = pw.Document();
          ...
          return pw.Column(
            ...
            children: [
              ...
              _buildEmploiInfo(
                formateurName,
                semaineNum,
                title: 'EMPLOI DU TEMPS INDIVIDUEL',
              ),
              pw.SizedBox(height: 10),
  ...
  static pw.Widget _buildEmploiInfo(
    String name,
    int semaineNum, {
    String title = 'EMPLOI DU TEMPS PAR GROUPE COURS DU JOUR',
  }) {
    return pw.Column(
      children: [
        pw.Container(
  ...
  static Future<void> generateNoteReportPdf(
    User user,
    List<Note> notes,
    List<Module> modules,
  ) async {
                    ...
                    return pw.TableRow(
                      children: [
                        ...
                        pw.Padding(
                          padding: const pw.EdgeInsets.all(5),
                          child: pw.Text(
                            n.type.toString().split('.').last.toUpperCase(),
                            style: const pw.TextStyle(fontSize: 10),
                          ),
                        ),
                        pw.Padding(
  ...
  static Future<void> generateProgressReportPdf(
          ...
          return pw.Column(
            ...
            children: [
              ...
              pw.Row(
                ...
                children: [
                  pw.Text(
                    'RAPPORT DE PROGRESSION PÉDAGOGIQUE',
                    style: pw.TextStyle(
                      fontSize: 18,
                      fontWeight: pw.FontWeight.bold,
                    ),
              ...
              pw.Table(
                ...
                children: [
                  ...
                  ...progressData.map((data) {
                    ...
                    final percent = (done / (total == 0 ? 1 : total) * 100)
                        .toStringAsFixed(1);
                    return pw.TableRow(
                      children: [
                        pw.Padding(
              ...
              pw.Row(
                ...
                children: [
                  pw.Text(
                    'Direction Pédagogique - Academic Pro',
                    style: pw.TextStyle(fontSize: 8, color: PdfColors.grey600),
                  ),
                  pw.Text(
                    'Page 1/1',
  ...
  static Future<void> generateFormalReclamationPdf({
    ...
    await Printing.layoutPdf(
      onLayout: (PdfPageFormat format) async => pdf.save(),
      name: 'Reclamation_${subject.replaceAll(' ', '_')}.pdf',
    );
  }

  static Future<void> generatePresenceReportPdf(
              ...
              pw.Table(
                ...
                children: [
                  ...
                  ...attendanceData.map((item) {
                    ...
                    final total = p + a + r;
                    final rate = total > 0
                        ? ((p + r) / total * 100).toStringAsFixed(1)
                        : '0.0';
                    return pw.TableRow(
                      children: [
                        pw.Padding(
    ...
    await Printing.layoutPdf(
      onLayout: (PdfPageFormat format) async => pdf.save(),
      name: 'Rapport_Presence_${groupName.replaceAll(' ', '_')}.pdf',
    );
  }
}
